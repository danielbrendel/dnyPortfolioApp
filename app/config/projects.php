...
return [
    [
        ...
        'links' => [
            'GitHub' => env('PL_HORTUSFOX_GITHUB'),
            'Homepage' => env('PL_HORTUSFOX_HOMEPAGE'),
            'Documentation' => env('PL_HORTUSFOX_DOCUMENTATION')
        ]
    ],
    ...
    [
        ...
        'links' => [
            'GitHub' => env('PL_HELPREALM_GITHUB'),
            'Homepage' => env('PL_HELPREALM_HOMEPAGE')
        ]
    ],
    ...
    [
        ...
        'links' => [
            'GitHub' => env('PL_STEAMWIDGETS_GITHUB'),
            'Homepage' => env('PL_STEAMWIDGETS_HOMEPAGE')
        ]
    ],
    ...
    [
        ...
        'links' => [
            'GitHub' => env('PL_AQUASHELL_GITHUB'),
            'Homepage' => env('PL_AQUASHELL_HOMEPAGE')
        ]
    ],
    ...
    [
        'name' => 'Asatru PHP Framework',
        'description' => 
            'The Asatru PHP framework is a lightweight PHP framework which can be used to create your own PHP apps using MVC design pattern. I use it for many of my own projects as an alternative to the Laravel PHP Framework.',
        'links' => [
            'GitHub' => env('PL_ASATRUPHP_GITHUB'),
